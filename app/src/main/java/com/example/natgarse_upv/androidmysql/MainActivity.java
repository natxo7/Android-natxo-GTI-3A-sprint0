...
import static com.example.natgarse_upv.androidmysql.R.id.txtMediciones;
...
public class MainActivity extends AppCompatActivity {
   ...
   /* public void boton_enviar_pulsado(View quien) {
    ...
    public void boto(View quien) {
        ...
        elPeticionario.hacerPeticionREST("POST", "http://10.236.35.194/ProyecteMediambientS0/insertar.php", textoJSON,
                new PeticionarioREST.RespuestaREST() {
                    @Override
                    public void callback(int codigo, String cuerpo) {
                        txtMediciones.setText("codigo respuesta= " + codigo + " <-> \n" + cuerpo);
